...
const KnowshareMeeting = () => {
  const { id } = useParams<{ id: string }>();
  const navigate = useNavigate();

  const meeting = {
    title: "Knowshare Meeting",
    date: "2024-06-25",
    time: "10:00",
    description: "Knowledge sharing session to discuss best practices and learnings",
    attendees: ["john@company.com", "sarah@company.com", "mike@company.com"],
    meetingType: "Knowshare"
  };
      ...
      <div className="container mx-auto px-6 py-6">
        <div className="bg-white rounded-lg border border-gray-200 p-6">
          ...
          <div className="mt-8 text-center text-gray-500">
            <p>Knowshare meeting interface coming soon...</p>
          </div>
        </div>
      </div>
    </div>
...
export default KnowshareMeeting;
